      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-8 mb-16">
          ...
          <div className="md:col-span-2 flex items-start gap-4 text-white">
            <a href="https://x.com/nagiai" className="hover:text-white/70 transition-colors" target="_blank" rel="noreferrer">
              <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-current">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
              </svg>
            </a>
            <a href="https://linkedin.com/company/nagiai" className="hover:text-white/70 transition-colors" target="_blank" rel="noreferrer">
              <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-current">
