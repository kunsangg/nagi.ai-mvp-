    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: 12, color: "#3bc9db", fontWeight: 600, fontFamily: MONO, textTransform: "uppercase", letterSpacing: "0.08em" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "48px 40px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{
              fontSize: 11, color: "#334155", fontFamily: MONO,
            ...
            <p style={{ fontSize: 13, color: "#334155", fontFamily: MONO }}>
                ...
                {review.keyFindings.map((f, i) => (
                  <li key={i} style={{ display: "flex", gap: 14 }}>
                    <span style={{
                      ...
                      fontFamily: MONO, minWidth: 24, paddingTop: 1,
                    }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {papers.map((p, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: "#3bc9db", fontFamily: MONO, flexShrink: 0, paddingTop: 1 }}>
                    [{i + 1}]
                  </span>
                  <div>
                    ...
                    {p.doi && (
                      <a href={`https://doi.org/${p.doi}`} target="_blank" rel="noopener noreferrer"
                        style={{ fontSize: 10, color: "#334155", fontFamily: MONO, display: "inline-flex", alignItems: "center", gap: 3, marginTop: 3 }}>
...
function CitedText({ text }: { text: string }) {
  ...
  return (
    <>
      {parts.map((part, i) =>
        /^\[\d+(?:,\s*\d+)*\]$/.test(part) ? (
          <sup key={i} style={{ color: "#3bc9db", fontFamily: MONO, fontSize: "0.75em", fontWeight: 700 }}>{part}</sup>
        ) : (
